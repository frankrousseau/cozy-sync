...
"use strict";
var CalDAV_CQValidator, CalendarQueryParser, CozyCalDAVBackend, Exc, ICalParser, SCCS, VCalendar, VEvent, VObject_Reader, VTimezone, WebdavAccount, async, axon, time, _ref,
...
module.exports = CozyCalDAVBackend = (function() {
  ...
  CozyCalDAVBackend.prototype.getCalendarsName = function(callback) {
    return this.Event.tags(function(err, results) {
