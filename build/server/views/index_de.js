...
buf.push("</select></p><p>Dann benutzen Sie die folgende URL:</p><p id=\"thunderbirduri\" class=\"url\"></p></div><h1>CardDAV Konfiguration (Kontakte)</h1><p>Ihr Client wird nach einer URL zur Verbindung fragen, hier sind die\nbenötigten, abhängig von Ihrem Smartphone oder der Software.</p><h2 data-device=\"ios\" class=\"tab carddav selected\">iOS</h2><h2 data-device=\"android\" class=\"tab carddav\">Android</h2><h2 data-device=\"thunderbird\" class=\"tab carddav\">Thunderbird (SOGo)</h2><div data-device=\"ios\" class=\"carddavconf\"><p>In das Feld \"Server\", eintragen:</p><p class=\"url\">" + (jade.escape((jade.interp = dDomain) == null ? '' : jade.interp)) + "/public/sync</p></div><div data-device=\"android\" class=\"carddavconf\"><p>Um Ihr Android Smartphone mit CalDAV zu synchronisieren, müssen Sie\neine entsprechende APP installieren. Die benötigte URL hängt von der App ab.\nAber Sie können es mit dieser Standard URL versuchen:</p><p class=\"url\">https://" + (jade.escape((jade.interp = dDomain) == null ? '' : jade.interp)) + "/public/sync/principals/me/</p></div><div data-device=\"thunderbird\" class=\"carddavconf\"><p>Um Kontakte mit Thunderbird zu synchronisieren, müssen Sie das SOGo addon\ninstallieren. Dann folgende URL benutzen:</p><p class=\"url\">https://" + (jade.escape((jade.interp = dDomain) == null ? '' : jade.interp)) + "/public/sync/addressbooks/me/all-contacts/</p></div><h1>WebDAV Konfiguration (Dateien)</h1><p>Cozy unterstützt die Datei_Synchronisation via WebDAV nicht. Wir werden bald einen\nanderen Weg dafür bereitstellen. Es wird auch \"Offline\" arbeiten unterstützen.</p><h1>Problemlösung</h1><p>Wenn Sie einen anderen Client nutzen und Probleme auftreten,\nbitte informieren Sie uns darüber it&nbsp;<a target=\"_blank\" href=\"https://github.com/mycozycloud/cozy-webdav/issues\">on Github!</a></p></div><script>window.password = \"" + (jade.escape((jade.interp = password) == null ? '' : jade.interp)) + "\";</script><script src=\"javascripts/vendor.js\"></script><script src=\"javascripts/app.js\" onload=\"require('initialize');\"></script></body></html>");;return buf.join("");
}