...
buf.push("</select></p><p>Then use the following url:</p><p id=\"thunderbirduri\" class=\"url\"></p></div></div></div><div class=\"content-block\"><h1>CardDAV configuration (Contacts)</h1><p>Your client will ask for an url on which to connect, here are the\nrequired ones, depending on your phone or software.</p><div class=\"content-tab\"><div class=\"menu-tab\"><h2 data-device=\"ios\" class=\"tab carddav selected\">iOS</h2><h2 data-device=\"android\" class=\"tab carddav\">Android</h2><h2 data-device=\"thunderbird\" class=\"tab carddav\">Thunderbird (SOGo)</h2></div><div data-device=\"ios\" class=\"carddavconf\"><p>In the \"Server\" field, type:</p><p class=\"url\">" + (jade.escape((jade.interp = dDomain) == null ? '' : jade.interp)) + "/public/sync</p></div><div data-device=\"android\" class=\"carddavconf\"><p>To sync your android phone with CardDAV, you have\nto install a dedicated app. The required url depend of your app. But\nyou can try that one by default:</p><p class=\"url\">https://" + (jade.escape((jade.interp = dDomain) == null ? '' : jade.interp)) + "/public/sync/principals/me/</p></div><div data-device=\"thunderbird\" class=\"carddavconf\"><p>To sync contacts with thunderbird, you have to install the SOGo\naddon. Then use the following url:</p><p class=\"url\">https://" + (jade.escape((jade.interp = dDomain) == null ? '' : jade.interp)) + "/public/sync/addressbooks/me/all-contacts/</p></div></div></div><div class=\"content-block\"><h1>WebDAV configuration (Files)</h1><p>Cozy doesn't support file synchronization through WebDAV. We will\nprovide soon another way to do it. It will support offline working\ntoo.</p></div><div class=\"content-block\"><h1>Troubleshooting</h1><p>If you use another client and are experimenting\nproblems, please let us know about it&nbsp;<a target=\"_blank\" href=\"https://github.com/mycozycloud/cozy-webdav/issues\">on Github!</a></p></div></div><script>window.password = \"" + (jade.escape((jade.interp = password) == null ? '' : jade.interp)) + "\";</script><script src=\"javascripts/vendor.js\"></script><script src=\"javascripts/app.js\" onload=\"require('initialize');\"></script></body></html>");;return buf.join("");
}