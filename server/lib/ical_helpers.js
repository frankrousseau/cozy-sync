...
var ICalParser, VAlarm, VCalendar, VComponent, VDaylight, VEvent, VFreeBusy, VJournal, VStandard, VTimezone, VTodo, fs, iCalBuffer, lazy, moment, _ref, _ref1, _ref2, _ref3, _ref4,
...
module.exports.VTimezone = VTimezone = (function(_super) {
  ...
  function VTimezone() {
    _ref = VTimezone.__super__.constructor.apply(this, arguments);
    return _ref;
  }
...
module.exports.VJournal = VJournal = (function(_super) {
  ...
  function VJournal() {
    _ref1 = VJournal.__super__.constructor.apply(this, arguments);
    return _ref1;
  }
...
module.exports.VFreeBusy = VFreeBusy = (function(_super) {
  ...
  function VFreeBusy() {
    _ref2 = VFreeBusy.__super__.constructor.apply(this, arguments);
    return _ref2;
  }
...
module.exports.VStandard = VStandard = (function(_super) {
  ...
  function VStandard() {
    _ref3 = VStandard.__super__.constructor.apply(this, arguments);
    return _ref3;
  }
...
module.exports.VDaylight = VDaylight = (function(_super) {
  ...
  function VDaylight() {
    _ref4 = VDaylight.__super__.constructor.apply(this, arguments);
    return _ref4;
  }
...
module.exports.ICalParser = ICalParser = (function() {
  ...
  ICalParser.prototype.parseString = function(string, callback) {
    var FakeStream, fakeStream, _ref5;
    FakeStream = (function(_super) {
      __extends(FakeStream, _super);

      function FakeStream() {
        _ref5 = FakeStream.__super__.constructor.apply(this, arguments);
        return _ref5;
      }
